          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <input
                  id="remember"
                  type="checkbox"
                  className="w-4 h-4 text-[#e21b70] bg-gray-100 border-gray-300 rounded focus:ring-[#e21b70]"
                />
                <Label htmlFor="remember" className="text-sm text-gray-600">
                  Remember me
                </Label>
              </div>
              <Link href="#" className="text-sm text-[#e21b70] hover:text-pink-700 font-medium">
                Forgot password?
              </Link>
            </div>
            ...
            <div className="text-center">
              <p className="text-gray-600">
                ...
                <Link
                  href="/auth/register"
                  className="font-semibold text-[#e21b70] hover:text-pink-700 transition-colors"
                >
                  Sign up
                </Link>
              </p>
